...
void PlotQCDPredictionsMC()
{
   ...
   // lumi text
   TString HistLabel = "CMS Simulation, L = 19.47 fb^{  -1}, #sqrt{s} = 8 TeV";
   ...
   TCanvas *c = PlottingUtils::DrawHistPlusCurveWithRatio("NJets_baseline_withoutMHT_pred_px", 
                                                          "NJets_baseline_withoutMHT_sel", "N_{Jets}", "Events",
   ...
   c->Print( psfile  + "[");
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/NJets_baseline_withoutMHT_" + postfix + ".png" );

   c = PlottingUtils::DrawHistPlusCurveWithRatio("NJets_baseline_withoutDeltaPhi_pred_px", 
                                                 "NJets_baseline_withoutDeltaPhi_sel", "N_{Jets}", "Events",
                                                 "N_{Jets} #geq 3, H_{T} > 500 GeV, #slash{H}_{T} > 200 GeV ", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle);
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/NJets_baseline_withoutDeltaPhi_" + postfix + ".png" );
   ...
   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin1_HTlow_pred_px", 
                                                 ...
                                                 "Events", "N_{Jets} = 2, #Delta#phi cut, H_{T} = 500 - 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle);
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin1_HTlow_" + postfix + ".png" );

   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin2_HTlow_pred_px", 
                                                 "MHT_JetBin2_HTlow_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "3 #leq N_{Jets} #leq 5, #Delta#phi cut, H_{T} = 500 - 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle); 
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin2_HTlow_" + postfix + ".png" );
 
   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin3_HTlow_pred_px", 
                                                 "MHT_JetBin3_HTlow_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "6 #leq N_{Jets} #leq 7, #Delta#phi cut, H_{T} = 500 - 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle); 
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin3_HTlow_" + postfix + ".png" );

   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin4_HTlow_pred_px", 
                                                 "MHT_JetBin4_HTlow_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "N_{Jets} #geq 8, #Delta#phi cut, H_{T} = 500 - 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle); 
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin4_HTlow_" + postfix + ".png" );

   // --------------------------------------------------------------------------------------------- //
   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin1_HThigh_pred_px", 
                                                 "MHT_JetBin1_HThigh_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "N_{Jets} = 2, #Delta#phi cut, H_{T} #geq 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle);
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin1_HThigh_" + postfix + ".png" );

   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin2_HThigh_pred_px", 
                                                 "MHT_JetBin2_HThigh_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "3 #leq N_{Jets} #leq 5, #Delta#phi cut, H_{T} #geq 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle); 
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin2_HThigh_" + postfix + ".png" );

   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin3_HThigh_pred_px", 
                                                 "MHT_JetBin3_HThigh_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "6 #leq N_{Jets} #leq 7, #Delta#phi cut, H_{T} #geq 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle); 
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin3_HThigh_" + postfix + ".png" ); 
 

   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_JetBin4_HThigh_pred_px", 
                                                 "MHT_JetBin4_HThigh_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "N_{Jets} #geq 8, #Delta#phi cut, H_{T} #geq 1000 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle); 
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_JetBin4_HThigh_" + postfix + ".png" ); 
   // --------------------------------------------------------------------------------------------- //
   // MHT for baseline
   c = PlottingUtils::DrawHistPlusCurveWithRatio("MHT_baseline_pred_px", 
                                                 "MHT_baseline_sel", "#slash{H}_{T} [GeV]", 
                                                 "Events", "N_{Jets} #geq 3, #Delta#phi cut, H_{T} > 500 GeV", 
                                                 HistLabel, 
                                                 Hist1Legend, Hist2Legend,
                                                 RatioTitle);
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/MHT_baseline_" + postfix + ".png" );
   ...
   c = PlottingUtils::DrawHistPlusCurveWithRatio("deltaPhi_HT_prediction_px", 
                                                 ...
                                                 RatioTitle);
   c->Print( psfile );
   c->Print( "QCDPredictionPlots/HT_baseline_withoutMHT_" + postfix + ".png" );
